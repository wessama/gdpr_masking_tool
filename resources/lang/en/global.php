...
return [
    ...
    'content'                              => 'Content',
    'no_alerts'                            => 'No alerts',
    'successMessage'                       => ':request request successfully submitted',
    'errorMessage'                         => 'Error encountered while :operation, :reason',
    'warningMessage'                       => 'Warning encountered! :reason',
    'error_servicing_req'                  => 'An error was encountered while servicing :count requests. Review the log for more info',
    'bulk_rtbf'                            => 'Bulk RTBF',
    'mass_request_error'                   => 'An error was encountered while servicing this request, :ex',
];
